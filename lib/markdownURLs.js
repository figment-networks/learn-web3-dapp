...
=======
    RUN_A_GRAPH_NODE: `${MARKDOWN_URI}/the_graph/02-node.md`,
    SCAFFOLD_A_SUBGRAPH: `${MARKDOWN_URI}/the_graph/03-subgraph.md`,
    HACKING_THE_MANIFEST: `${MARKDOWN_URI}/the_graph/04-manifest.md`,
    ENTITY_AND_RELATION: `${MARKDOWN_URI}/the_graph/05-entities.md`,
    DEFINE_THE_MAPPING: `${MARKDOWN_URI}/the_graph/06-mappings.md`,
    QUERYING_THE_SUBGRAPH: `${MARKDOWN_URI}/the_graph/07-query.md`,
>>>>>>> Stashed changes
  },
};
